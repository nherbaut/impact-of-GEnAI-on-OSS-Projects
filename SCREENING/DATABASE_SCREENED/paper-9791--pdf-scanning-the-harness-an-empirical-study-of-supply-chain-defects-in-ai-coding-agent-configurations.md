...
bibliography:
  ...
  doi: null
links:
  source: mendeley:696084d7-4120-365c-bfd8-816bee044850
...
source:
  ...
  discovered_at: '2026-09-09T11:27:54.752864Z'
workflow:
  state:
...
files:
  pdf:
    available: true
    name: paper-9791--pdf-scanning-the-harness-an-empirical-study-of-supply-chain-defects-in-ai-coding-agent-configurations.pdf
    original_name: 2609.07360v1.pdf
---

Siiiii ça marche!<br/>meme avec la synchro en tache de fond?<br/>et oui, c'est de la balle non ?